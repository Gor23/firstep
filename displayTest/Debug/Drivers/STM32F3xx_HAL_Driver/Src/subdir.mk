...
Drivers/STM32F3xx_HAL_Driver/Src/%.o: ../Drivers/STM32F3xx_HAL_Driver/Src/%.c
	...
	@echo %cd%
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -D__weak="__attribute__((weak))" -D__packed="__attribute__((__packed__))" -DUSE_HAL_DRIVER -DSTM32F303xC -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Inc" -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Drivers/STM32F3xx_HAL_Driver/Inc" -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Drivers/STM32F3xx_HAL_Driver/Inc/Legacy" -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Middlewares/ST/STM32_USB_Device_Library/Core/Inc" -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc" -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Drivers/CMSIS/Include" -I"C:/Documents and Settings/Администратор/Мои документы/Dropbox/prj/displayTest/Drivers/CMSIS/Device/ST/STM32F3xx/Include"  -Os -g3 -Wall -fmessage-length=0 -ffunction-sections -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
